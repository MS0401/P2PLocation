...
class ViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate {
    ...
    var register:RegisterViewController! = nil
    ...
    override func viewDidLoad() {
        ...
        print("Unique ID is \(uuid)")//E0CD3A3C-96CA-4BE1-89F5-98B9B566BD54
        currentPage = 0
    ...
    private func createPageViewController() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            self.pageController.view.frame = CGRect(x: 0, y: 150, width: self.view.frame.size.width, height: self.view.frame.size.height-150)
        }
        
        let homeStoryboard = UIStoryboard(name: "Main", bundle: nil)
        login = homeStoryboard.instantiateViewController(withIdentifier: "login") as! LoginViewController
        register = homeStoryboard.instantiateViewController(withIdentifier: "register") as! RegisterViewController
        //        tab3VC = homeStoryboard.instantiateViewController(withIdentifier: "Tab3VC") as! Tab3VC
        
        arrVC = [login, register]
        
        pageController.setViewControllers([login], direction: UIPageViewControllerNavigationDirection.forward, animated: false, completion: nil)
